...
//#undef _XMLWINDOWS // TrueThought: Commented this out since wide char decision shouldn't have anything to do with being windows or not windows...stupid
#undef _XMLWIDECHAR
#endif
...
typedef struct XMLAttribute {
	...
	// TrueThought added
	//-------------------------------------------------------------------
	bool	wasAttributeUsed ;
	XMLAttribute() : wasAttributeUsed( false ), lpszName( NULL ), lpszValue( NULL ) { }
	//-------------------------------------------------------------------
} XMLAttribute;
